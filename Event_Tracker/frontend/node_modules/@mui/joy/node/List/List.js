...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant && `variant${(0, _utils.unstable_capitalize)(variant)}`, color && `color${(0, _utils.unstable_capitalize)(color)}`, size && `size${(0, _utils.unstable_capitalize)(size)}`, nesting && 'nesting', row && 'row', scoped && 'scoped']
  };
...
const ListRoot = (0, _styles.styled)('ul', {
  ...
  return [ownerState.nesting && !ownerState.scoped && (0, _extends2.default)({}, applySizeVars(ownerState.instanceSize), {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_RowListContext.default.Provider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_WrapListContext.default.Provider, {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_ComponentListContext.default.Provider, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(ListRoot, (0, _extends2.default)({
          ref: ref,
          as: component,
...
= {
   ...
   * @default false
   */
  scoped: _propTypes.default.bool,
